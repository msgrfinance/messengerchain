...
func createTestApp(isCheckTx bool, tempDir string) (*msgrcapp.MsgrcApp, sdk.Context) {
	app := msgrcapp.NewMsgrcApp(
		log.NewNopLogger(), dbm.NewMemDB(), nil, true, map[int64]bool{},
		tempDir, simapp.FlagPeriodValue, msgrcapp.MakeEncodingConfig(),
