...
var (
	_ servertypes.Application = (*MsgrcApp)(nil)
)
...
// MsgrcApp extends an ABCI application, but with most of its parameters exported.
// They are exported for convenience in creating helper functions, as object
// capabilities aren't needed for testing.
type MsgrcApp struct {
	*baseapp.BaseApp
...
// NewMsgrcApp returns a reference to an initialized Msgrc.
func NewMsgrcApp(
	logger log.Logger,
	db dbm.DB,
	...
	homePath string,
	invCheckPeriod uint,
	encodingConfig msgrcappparams.EncodingConfig,
...
func (app *MsgrcApp) Name() string { return app.BaseApp.Name() }

// BeginBlocker application updates every begin block
func (app *MsgrcApp) BeginBlocker(ctx sdk.Context, req abci.RequestBeginBlock) abci.ResponseBeginBlock {
	return app.mm.BeginBlock(ctx, req)
}

// EndBlocker application updates every end block
func (app *MsgrcApp) EndBlocker(ctx sdk.Context, req abci.RequestEndBlock) abci.ResponseEndBlock {
	return app.mm.EndBlock(ctx, req)
}

// InitChainer application update at chain initialization
func (app *MsgrcApp) InitChainer(ctx sdk.Context, req abci.RequestInitChain) abci.ResponseInitChain {
...
func (app *MsgrcApp) LoadHeight(height int64) error {
	return app.LoadVersion(height)
}

// ModuleAccountAddrs returns all the app's module account addresses.
func (app *MsgrcApp) ModuleAccountAddrs() map[string]bool {
...
func (app *MsgrcApp) LegacyAmino() *codec.LegacyAmino {
	return app.cdc
}

// AppCodec returns Msgrc's app codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *MsgrcApp) AppCodec() codec.Codec {
	return app.appCodec
}

// InterfaceRegistry returns Msgrc's InterfaceRegistry
func (app *MsgrcApp) InterfaceRegistry() types.InterfaceRegistry {
...
func (app *MsgrcApp) GetKey(storeKey string) *sdk.KVStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *MsgrcApp) GetTKey(storeKey string) *sdk.TransientStoreKey {
...
func (app *MsgrcApp) GetMemKey(storeKey string) *sdk.MemoryStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *MsgrcApp) GetSubspace(moduleName string) paramstypes.Subspace {
...
// API server.
func (app *MsgrcApp) RegisterAPIRoutes(apiSvr *api.Server, apiConfig config.APIConfig) {
...
func (app *MsgrcApp) RegisterTxService(clientCtx client.Context) {
	authtx.RegisterTxService(app.BaseApp.GRPCQueryRouter(), clientCtx, app.BaseApp.Simulate, app.interfaceRegistry)
}

// RegisterTendermintService implements the Application.RegisterTendermintService method.
func (app *MsgrcApp) RegisterTendermintService(clientCtx client.Context) {
	tmservice.RegisterTendermintService(app.BaseApp.GRPCQueryRouter(), clientCtx, app.interfaceRegistry)
}

// RegisterUpgradeHandlers returns upgrade handlers
func (app *MsgrcApp) RegisterUpgradeHandlers(cfg module.Configurator) {
...
func (app *MsgrcApp) enforceStakingForVestingTokens(ctx sdk.Context, genesisState GenesisState) {
