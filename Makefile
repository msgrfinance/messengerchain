...
ldflags = -X github.com/cosmos/cosmos-sdk/version.Name=msgrc \
		  -X github.com/cosmos/cosmos-sdk/version.AppName=msgrcd \
...
ifeq ($(OS),Windows_NT)
	...
	go build -mod=readonly $(BUILD_FLAGS) -o build/msgrcd ./cmd/msgrcd
endif
...
install: go.sum 
	go install -mod=readonly $(BUILD_FLAGS) ./cmd/msgrcd
...
draw-deps:
	...
	@goviz -i ./cmd/msgrcd -d 2 | dot -Tpng -o dependency-graph.png
